...
p hash.has_key?(2) # true
p hash.has_value?("zero") # true
p hash.include?(5) # true   #=> only hash key is checkable?
p hash.include?("zero") # false     #=> hash value is NOT checkable?
...
# array_1 = [4, 2, 0, 2]
# p ele_replace!(array_1, {2=>"two", 0=>"zero", 5=>"five"})
