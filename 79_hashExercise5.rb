# Hash Exercise 5 : Cat Builder
# Write a method cat_builder 
# that takes in a name, color, and age. 
# The method should return a hash 
# representing a cat with those values.


# input type : string, string, age
# output(to return) type : string, string, age / hash
